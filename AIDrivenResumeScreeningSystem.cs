...
class Program
{
    static void Main()
    {
        ...
        var resume1 = new Resume<SoftwareEngineer>("Alice Johnson", 5, new SoftwareEngineer());
        var resume2 = new Resume<SoftwareEngineer>("Bob Smith", 3, new SoftwareEngineer());
        var resume3 = new Resume<DataScientist>("Charlie Brown", 4, new DataScientist());
        var resume4 = new Resume<DataScientist>("David Lee", 6, new DataScientist());
