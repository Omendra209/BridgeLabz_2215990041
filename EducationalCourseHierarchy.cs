...
public class OnlineCourse : Course
{
    ...
    {
        Console.WriteLine("Course: {0}, Duration: {1} weeks, Platform: {2}, Recorded: {3}", CourseName, Duration, Platform, IsRecorded ? "Yes" : "No");
    }
}
...
public class PaidOnlineCourse : OnlineCourse
{
    ...
    public override void DisplayCourseInfo()
    {
        ...
        Console.WriteLine("Course: {0}, Duration: {1} weeks, Platform: {2}, Recorded: {3}, Fee: ${4}, Discount: {5}%, Final Price: ${6}",
            CourseName, Duration, Platform, IsRecorded ? "Yes" : "No", Fee, Discount, finalPrice);
    }
}
...
public class Program
{
    public static void Main()
    {
        ...
        PaidOnlineCourse paidCourse = new PaidOnlineCourse("Machine Learning", 8, "Coursera", true, 200, 10);
