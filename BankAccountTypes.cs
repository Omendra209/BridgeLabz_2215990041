...
public class SavingsAccount : BankAccount
{
    ...
    {
        Console.WriteLine("Savings Account with Interest Rate: {0}%", InterestRate);
    }
}
...
public class CheckingAccount : BankAccount
{
    ...
    public override void DisplayAccountType()
    {
        Console.WriteLine("Checking Account with Withdrawal Limit: {0}", WithdrawalLimit);
    }
}
...
public class FixedDepositAccount : BankAccount
{
    ...
    public override void DisplayAccountType()
    {
        Console.WriteLine("Fixed Deposit Account with Term: {0} months", DepositTerm);
    }
}
