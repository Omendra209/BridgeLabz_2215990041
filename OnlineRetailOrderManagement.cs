...
public class Program
{
    public static void Main()
    {
        ...
        ShippedOrder shippedOrder = new ShippedOrder(1002, "2025-02-05", "XYZ123456");
        Console.WriteLine(shippedOrder.GetOrderStatus());

        DeliveredOrder deliveredOrder = new DeliveredOrder(1003, "2025-02-04", "ABC789101", "2025-02-07");
